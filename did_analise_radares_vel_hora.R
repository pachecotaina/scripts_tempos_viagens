...
plot_y_lab <- "ATT (velocidade média - km/h)"
...
write.csv(att_summary_table, paste0(res_folder, "/att_summary_table.csv"), row.names = FALSE)
write.csv(aggte_combined_summary, paste0(res_folder, "/aggte_combined_summary.csv"), row.names = FALSE)
