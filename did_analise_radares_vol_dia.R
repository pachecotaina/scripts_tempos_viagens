...
for (j in seq_along(control_type)) {
  for (i in seq_along(vec_dep_hours)) {
    ...
    tryCatch({
      ...
      saveRDS(att, paste0("results_radares_vol_dia/att_hour_vol_dia.rds"))
      ...
      ggsave(
        paste0("figures_radares_vol_dia/ES_per_group_hour_vol_dia_", control_type[j], ".png"), 
        p_es_group, 
        width = 10, 
        height = 6.25)
      ...
      if (length(sig_groups) > 0) {
        ...
        ggsave(
          paste0("figures_radares_vol_dia/siggroups_hour_vol_dia_", control_type[j], ".png"), 
          p_groups_2col, 
          width = 14, 
          height = 8)
        ...
        ggsave(
          paste0("figures_radares_vol_dia/siggroups_hour_vol_dia_", control_type[j], "_1col.png"), 
          p_groups_1col, 
          width = 20, 
          height = 27)
        ...
        ggsave(
          paste0("figures_radares_vol_dia/eventstudy_hour_vol_dia_", control_type[j], ".png"), 
          p_es, 
          width = 10, 
          height = 6.25)
...
ggsave(
  paste0("figures_radares_vol_dia/did_att_all_vol_dia.png"), 
  plot = last_plot(), 
  width = 14, 
  height = 8)