...
plot_title <- "Efeitos por grupo de tratamento - velocidade média - km/h"
plot_title_dyn <- "Efeito dinâmico - velocidade média - km/h"

att_summary_table_name <- "/att_log_summary_table_vel_hour_only07.csv"
aggte_combined_summary_name <-  "/aggte_log_combined_summary_vel_hour_only07.csv"
