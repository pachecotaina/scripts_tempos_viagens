...
plot_y_lab <-"ATT (Δ fator hora pico - 15 minutos)"
plot_title <- "Efeitos por grupo de tratamento - fator hora pico - 15 minutos"
plot_title_dyn <- "Efeito dinâmico - fator hora pico - 15 minutos"

att_summary_table_name <- "/att_log_summary_table_fhp15min_only07.csv"
aggte_combined_summary_name <-  "/aggte_log_combined_summary_fhp15min_only07.csv"
